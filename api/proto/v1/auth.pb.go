...
const file_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\rv1/auth.proto\x12\x11asaycle.routiq.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\".\n" +
	...
	"\n" +
	"token_type\x18\x04 \x01(\tR\ttokenType\"7\n" +
	"\x12VerifyTokenRequest\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\"B\n" +
	"\x13VerifyTokenResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role2\x9a\x03\n" +
	"\vAuthService\x12\x8f\x01\n" +
	"\x11ExchangeOAuthCode\x12+.asaycle.routiq.v1.ExchangeOAuthCodeRequest\x1a,.asaycle.routiq.v1.ExchangeOAuthCodeResponse\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/v1/auth/oauth/callback\x12~\n" +
	"\fRefreshToken\x12&.asaycle.routiq.v1.RefreshTokenRequest\x1a'.asaycle.routiq.v1.RefreshTokenResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/tokens:refresh\x12y\n" +
	"\vVerifyToken\x12%.asaycle.routiq.v1.VerifyTokenRequest\x1a&.asaycle.routiq.v1.VerifyTokenResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/token:verifyB/Z-github.com/asaycle/routiq/api/proto/v1;routiqb\x06proto3"
