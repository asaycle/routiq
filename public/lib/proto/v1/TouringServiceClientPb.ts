...
export class TouringServiceClient {
  ...
  methodDescriptorGetTouring = new grpcWeb.MethodDescriptor(
    ...
    v1_touring_pb.GetTouringResponse,
    (request: v1_touring_pb.GetTouringRequest) => {
      return request.serializeBinary();
    },
    v1_touring_pb.GetTouringResponse.deserializeBinary
  );

  getTouring(
    request: v1_touring_pb.GetTouringRequest,
    metadata?: grpcWeb.Metadata | null): Promise<v1_touring_pb.GetTouringResponse>;

  getTouring(
    request: v1_touring_pb.GetTouringRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: v1_touring_pb.GetTouringResponse) => void): grpcWeb.ClientReadableStream<v1_touring_pb.GetTouringResponse>;
